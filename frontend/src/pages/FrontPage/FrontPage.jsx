  ...
  return (
    <div className="min-h-screen bg-black">
      <header className="p-8 text-white">
        <div className="mt-40 grid min-h-screen w-full place-items-stretch bg-contain bg-center bg-no-repeat md:h-auto lg:h-auto">
          <div className="container mx-auto px-4 text-center">
            ...
            <button className="mt-6 inline-flex items-center rounded border border-white bg-black px-4 py-3 font-bold text-white hover:scale-105 hover:bg-gray-400">
              <svg
              ...
              <span className="text-2xl">Get Started Today</span>
            </button>
